...
**MagSeed** [Hazard | Near] Throws a seed that turns a surface magnetic on contact. (Awkward)  
...
**MiniBomb** [Thrown | 1 Damage | Near] A tiny blue bomb. Spend 1 Info point: this chip will not be exhausted while jacked in.  
...
**RadicalGrind** [Rush | 2 Damage | Near] Grind an edge and ram the target! Pick 1: downshift your next Speed, Charm, or Bravery roll. (Awkward)  
**Catapult** [Shot | Near] Slot in a Thrown BattleChip; this will give it properties of a Shot chip and +1 damage.  
**ElecReel** [Summon | 2 Damage | Close] Summons a hidden electric tripwire that shocks anything it touches.  
**EleMentalist** [Summon | Near] Write any element down, tell others its 1st letter. If a player guesses it 1st try, summon lots of it!  
**Mole** [Summon | Close] Summons a mole which digs a tunnel to a simple, nearby destination. (Slow)  
**PopUp** [Summon | Close] Creates a foxhole right beneath your feet.  
...
**Recover3** [Support] Recover three HP.  
**TundraSpotlight** [Support | Near] Casts the Navi in a rainbow light that draws attention and downshifts its next Soul roll.  
**DiceBomb** [Thrown | X Damage | Near] A randomized attack! X=Roll 2d6, use the lowest value as your damage.  
**FlamingLasso** [Thrown | 2 Damage | Near] Can spend 1 Strength to: pull them Close, upshift their next roll, or get dragged behind them.  
**SeekBomb** [Thrown | 2 Damage | Near] If target tries to evade with Speed, upshift difficulty.  
**StickyStick** [Thrown | 2 Damage | Near] Tosses a 10-foot pole. Sticks to whatever it hits; difficult to break. (Awkward)  
**Tornado** [Wave | 2 Damage | Near] Creates a swirling cyclone that rolls forward, flinging everything in its path. (Slow, Dangerous)  
...
**GutPunch** [Impact | 3 Damage | Close] A massive punch that reduces enemy Stamina by 1. (Awkward)  
...
**DesertLions** [Wave | 3 Damage | Near] Sand lions attack, trailing sand. Spend 1 Charm: Target sees mirages of your choice. (Awkward, Slow)  
...
**2000z:**  
**DoubleEdge** [Blade | 4 Damage | Close] You also take 4 damage if the target is not deleted by your attack.  
**LightWave** [Blade | 2 Damage | Near] Fires a glowing shockwave from a blade that ignores barriers, shields, and auras.  
**BurnSquare** [Hazard | 3 Damage | Near] A nearby surface shatters as flames erupt from it, burning anyone Close to it. (Dangerous)  
**RollFlash** [Rush | 2 Damage | Near] Warp Close to an enemy and whip them! Spend 1 Charm: Heal a Near ally 2 HP.  
**StepSword** [Rush | 3 Damage | Near] Teleports you forward for a single slice, then you go back.  
...
**RideOn** [1 EB] - On jack in, you have a cool, small ride (e.g. roller skates, snowboard, pogostick).  
...
**1000z:**  
**AsynchronousI/O** [2 EB] - You can make one downshifted action while jacking in or out.  
**ProgBody** [1 EB] - Your NetNavi appears like a ProgForm you've seen before!  
**SignPost** [1 EB] - You can leave a sign, similar to a BBS post, anywhere in the net.  
**Sprite** [3 EB] - The Navi can turn two-dimensional. Your attacks are upshifted when flattened.  
**Ventrillo** [2 EB] - You can make your voice come from anywhere in Near range.  
  
**1500z:**  
**BladeRun** [2 EB] - Can move a range band without rolling when attacking with a Blade chip.  
**Collect** [2 EB] - When you download a deleted Virus into a blank BattleChip, downshift the roll.  
**PassengerMode** [2 EB] - You can take a Close target with you when you use Rush chips.  
...
**Meltdown** [4 EB] - Can add bonus dice to your roll for HP, 1 HP per die. Max 3 dice added per roll.  
**Custom+2** [3 EB] - Raises maximum folder size by two.  
