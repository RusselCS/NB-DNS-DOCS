...
In addition, there are networks that can be accessed without having to Jack In. Wi-Fi networks and such exist and can generally just access without so much as a second thought. If a Jack In port isn't immediately available, you can assume some device in the immediate vicinity has access to it. Private or secured networks still require Jacking In, though.
